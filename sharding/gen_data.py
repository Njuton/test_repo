...
# инстанс БД диалогов шардированный
CITUS_DB_PORT = 5460
CITUS_DB_NAME = 'postgres'
CITUS_DB_USER = 'postgres'
CITUS_DB_PASSWORD = 'postgres'
CITUS_DB_HOST = 'localhost'
...
def main():
    ...
    conn_citus = psycopg2.connect(
        host=CITUS_DB_HOST,
        database=CITUS_DB_NAME,
        user=CITUS_DB_USER,
        ...
        for user_id in users:
            for _ in range(20):
                ...
                for receiver_id in friendships[user_id]:
                    ...
                    create_message(conn_citus, sender_id, receiver_id, message_text)
